    ...
    Effect.gen(function* () {
      ...
      yield* fs.writeFileString(
        ...
        [
          ...
          '            { name: "pdf", description: "Work with PDFs (command mirror)", argumentHint: "" },',
          "          ],",
          "          agents: [],",
          ...
          "        request_id: message.request_id,",
          "        response: {",
          '          skills: [{ name: "pdf", description: "Work with PDFs", argumentHint: "" }],',
          "        },",
          "      },",
          '    }) + "\\n");',
          "  }",
      ...
      assert.deepEqual(capabilities, {
        ...
        // The `pdf` command mirrors the `pdf` skill, so the skill filter
        // removes it from the slash-command list.
        slashCommands: [
          {
            name: "review",
