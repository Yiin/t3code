...
const DEFAULT_CONFIG = {
  ...
  vcs: { noPush: false, runOwnedBaseBranch: false },
  orientation: { file: null },
  execution: { mode: "auto", sequential: false },
