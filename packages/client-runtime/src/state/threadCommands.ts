...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    steerSubagent: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:steer-subagent",
      execute: (input: SteerThreadSubagentInput) => steerThreadSubagent(input),
      scheduler,
      concurrency,
    }),
