...
The installer links `~/.agents/skills/{plan-epic,cook-epic,cook-it,ralph}` to
this checkout so plain Claude, Codex, and Kimi sessions use the same files.
Existing real files or directories are backed up before linking.
