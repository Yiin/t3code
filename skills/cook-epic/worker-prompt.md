...
6. Close out: `bd close @CHILD@`, then `bd note @EPIC@ "@CHILD@ done — <what changed, one clause>; branch @BRANCH@."` Mention any dependency you added or gotcha the remaining children need.
